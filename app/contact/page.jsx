        ...
        <div className="text-white grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="uppercase text-xl md:text-3xl font-semibold mb-8 font-sans1">
              Transform Your Space with VVI Designs: Elegance, Style, and
              Innovation.
            </h2>
            <form className="max-w-md" onSubmit={handleSubmit}>
              <div className="mb-4">
                <label
                  htmlFor="name"
                  className="block font-semibold mb-2 font-sans1"
                >
                  Enter Name
                </label>
                <input
              ...
              <button
                type="submit"
                className="bg-white text-gray-900 py-2 px-4 mt-4 hover:bg-gray-500 hover:text-white transition-colors focus:outline-none rounded-md"
              >
                Send
              </button>
              <p className="mt-4 text-xs font-sans1">
                By clicking on the "Send" button, I agree to the terms of the
                privacy policy.
              </p>
              {responseMessage && (
                <p className="mt-4 text-sm font-sans1">{responseMessage}</p>
              )}
            </form>
            <div className="mt-8">
              <p className="font-semibold font-sans1">HYDERABAD</p>
              <p className="font-sans1">Phone: +91 9949716589</p>
              <p className="font-sans1">Email: vviinteriors@gmail.com</p>
              <p className="font-sans1">
                Sri sai nagar colony ,Jillelaguda HYDERABAD ,500097
              </p>
            </div>
          </div>
