...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-8 relative">
      <div className="container mx-auto px-4 mt-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-gray-400">Email: vviinteriors@gmail.com</p>
            <p className="text-gray-400">Phone: +91 9949716589</p>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-8 pt-5 flex flex-col md:flex-row justify-between items-center max-h-1">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} VVI designs. All rights reserved.
          </p>
      ...
      <p className="relative text-xs mt-2 text-white/10 justify-center items-center flex mb-[-20px]">
        &copy; made by Aman Yadav
      </p>
    </footer>
  );
};
